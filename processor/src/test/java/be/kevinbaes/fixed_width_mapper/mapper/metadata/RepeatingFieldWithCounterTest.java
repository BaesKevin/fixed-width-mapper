...
class RepeatingFieldWithCounterTest {

    @Test
    public void repeatingFieldTest() {
        Field<Integer> countingField = new IntegerField("repeatingcounter", 2);
        RepeatingFieldWithCounter<String> repeatField = new RepeatingFieldWithCounter<>("repeatingfield", countingField, new StringField("base", 2));
    ...
    public void repeatingFieldWithIntegerTemplate() {
        Field<Integer> countingField = new IntegerField("repeatingcounter", 2);
        RepeatingFieldWithCounter<Integer> repeatField = new RepeatingFieldWithCounter<>("repeatingfield", countingField, new IntegerField("base", 2));
